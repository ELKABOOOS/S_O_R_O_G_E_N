...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/devid10/vsra/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1829540452,1654178416,1744196893}   
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/SO_S_O_R_O_G_E_N/main/DRAGON.lua')
...
{{text = 'مبرمجين السورس', url="t.me/UU_RO"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'TＷＡＳＯＬ', url="t.me/G_W_P_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
المبرمج الكابوس لو حابب تتوصل معاه
اتبع الزر إلى تحت ☆
...
if text == 'مارتن' or text == 'مطور السورس' or text == 'marten' then
local Text = [[
المبرمج مارتن
اتبع الزر إلى تحت ☆
...
if text == 'الماجيك' or text == 'مالك السورس' or text == 'كريم' then
local Text = [[
المبرمج الماجيك
اتبع الزر إلى تحت ☆
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/devid10/vsra/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/devid10/vsra/main/File_Bot/"..file)
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐍𝐆𝐄??𝐒.',url="t.me/SO_ROGEN"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '??𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓', url="t.me/SO_ROGEN"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
